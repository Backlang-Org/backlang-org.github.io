  ...
  return (
    <main>
      <section class="flex flex-col m-24">
        ...
        <button class="flex rounded-[1.25rem] mt-7 w-fit bg-green-500 hover:bg-green-400 px-4 py-2 focus:outline-none hover:scale-110 transition-all duration-150 ease-in-out">
